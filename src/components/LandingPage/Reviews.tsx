...
export default function Reviews(): React.FC {
  return (
    <section className=" w-full bg-gray-300  pt-5 pb-5">
      {/* <!-- Heading --> */}
      ...
      <div className=" w-[90%]  mx-auto gap-[20px] grid grid-cols-3 justify-center align-middle pb-[10px]  ">
          ...
          <div className="relative flex items-start border-2 border-gray-200 rounded bg-white">
            ...
            <div className="text-center px-12 py-8 pt-20 mx-4 md:mx-0">
              ...
              <blockquote className="text-xl mt-[15px] font-medium mb-4">
                ...
                delight. Kudos to the developers!"
              </blockquote>
              {/* Name */}
              <cite className="block font-bold text-lg not-italic mb-1">
                Mary Jane
