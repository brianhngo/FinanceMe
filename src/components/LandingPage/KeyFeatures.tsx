  ...
  return (
    <section className="bg-gray-300">
      <div className="text-center">
        ...
        <div className="grid grid-cols-4 pb-[40px] pt-[40px] w-[90%] mx-auto">
          <div className="flex w-[80%] justify-center p-5 mx-auto flex-col border rounded-xl bg-white shadow-md border-gray-200 hover:shadow-lg hover:transform hover:translate-y-[-10px] transition-transform duration-300 ease-in-out">
            ...
            />
            <h3 className="text-center max-w-[100%] mb-4 pt-4 text-lg  tracking-tight leading-none md:text-4xl  dark:text-black">
              {' '}
              Easy Budgeting
            </h3>
            <p className="mt-1 mb-4 inline-flex items-center justify-center px-5 py-3 mr-3 md:text-md xl:text-lg text-base font-medium text-center text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              {' '}
          ...
          <div className="flex w-[80%] p-5 mx-auto justify-center flex-col border rounded-xl bg-white shadow-md border-gray-200 hover:shadow-lg hover:transform hover:translate-y-[-10px] transition-transform duration-300 ease-in-out">
            <img
              className="w-[300px] h-[300px] mx-auto"
          ...
          <div className="flex w-[80%] p-5 mx-auto flex-col border justify-center rounded-xl bg-white shadow-md border-gray-200 hover:shadow-lg hover:transform hover:translate-y-[-10px] transition-transform duration-300 ease-in-out">
            <img
              className="w-[300px] h-[300px] mx-auto"
