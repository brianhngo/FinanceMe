...
export default function Preview1(): React.FC {
  return (
    <section className=" w-full bg-pink-300  mt-5 lg:mt-10">
      {/* <!-- Heading --> */}
      ...
      <div className=" w-full flex flex-row justify-center align-middle mt-20 lg:mt-16">
        <div className="container flex flex-col lg:flex-row items-center justify-center gap-x-24">
          ...
          <div className="flex flex-1 flex-col items-center lg:items-start">
            <h1 className="mt-1 mb-4 inline-flex items-center justify-center lg:text-right  py-3 mr-3 md:text-md xl:text-5xl text-base font-medium  text-black rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
              Establish Goal-Oriented Finances
            </h1>
            <p className="text-bookmark-grey xl:text-lg my-4 text-center lg:text-right sm:w-3/4 lg:w-full">
            ...
            <button
              type="button"
              className=" ml-auto text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-xl rounded-lg text-xl px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Join Now
            </button>
          </div>
          {/* <!-- Image --> */}
